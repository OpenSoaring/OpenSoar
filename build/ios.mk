...
ifeq ($(TESTING),y)
IOS_APP_BUNDLE_IDENTIFIER ?= $(PROGRAM_NAME)-testing
...
IOS_APP_BUNDLE_IDENTIFIER ?= $(PROGRAM_NAME)
...
$(TARGET_OUTPUT_DIR)/$(IPA_NAME): $(TARGET_BIN_DIR)/$(PROGRAM_NAME) $(TARGET_OUTPUT_DIR)/Info.plist $(IOS_GRAPHICS) $(IOS_SOUNDS)
	@$(NQ)echo "  IPA     $@"
	$(Q)rm -rf $(IPA_TMPDIR)
	$(Q)$(MKDIR) -p $(IPA_TMPDIR)/Payload/$(IOS_APP_DIR_NAME)
	$(Q)cp $(TARGET_BIN_DIR)/$(PROGRAM_NAME) $(IPA_TMPDIR)/Payload/$(IOS_APP_DIR_NAME)/$(PROGRAM_NAME)
