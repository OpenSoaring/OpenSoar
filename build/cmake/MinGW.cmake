...
set(COMPILER_PATH       D:/Programs/MinGW/${TOOLCHAIN})
set(COMPILER_LIB_PATH   ${COMPILER_PATH}/x86_64-w64-mingw32/lib)
...
###        msimg32
        ## => lib_ui D:/Programs/MinGW/mgw122/x86_64-w64-mingw32/lib/libmsimg32.a
###        winmm
###        # dl
###        pthread
###        stdc++
###        user32
        ### is schon... gdi32  # libui ?
#        gdiplus # libui ???
###        ws2_32
###        mswsock
###        # wsock32
...
string (APPEND CMAKE_EXE_LINKER_FLAGS       " -static -static-libstdc++ -Wl,-Bstatic,--whole-archive -Wl,--no-whole-archive")
