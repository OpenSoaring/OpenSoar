...
import os, sys
from CMakeOpenSoar import create_opensoar
...
if sys.platform.startswith('win'):
    if not toolchain in ['mgw73', 'mgw103', 'mgw112', 'mgw122', 'mgw143', 'ninja', 'msvc2019', 'msvc2022',
...
arguments = []
arguments.append('OpenSoar')   # project_name
