...
# Developer switches that must never be deployed belong in an untracked
# file beside this one: build/cmake/local-config.cmake, the CMake
# counterpart of build/local-config.mk.  It is read on every configure -
# and because an included file is a configure dependency, the IDE
# regenerates by itself after an edit, without running the Compile
# script again.  For the OpenVario menus that is one line:
#     set(TARGET_IS_OPENVARIO ON)
include(${CMAKE_CURRENT_LIST_DIR}/local-config.cmake OPTIONAL)

# only in DEBUG-Version---
# OpenVario menu On/Off: a developer aid for testing those menus on
# Windows, never part of a delivered build.  OFF here, ON either from
# local-config.cmake above, from the CMake cache (the IDE's cache view,
# cmake-gui) or with -DTARGET_IS_OPENVARIO=ON.
option(TARGET_IS_OPENVARIO "build the OpenVario menus (developer test build)" OFF)
