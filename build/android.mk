...
$(PROTOBUF_OUT_DIR)/dirstamp: $(PNG_FILES) $(SOUND_FILES) $(ANDROID_XML_RES_COPIES_NO_STRINGS) $(ANDROID_XML_RES_ICON_COPIES) $(RES_DIR)/values/strings.xml $(MANIFEST) | $(GEN_DIR)/dirstamp $(COMPILED_RES_DIR)/dirstamp
	@$(NQ)echo "  AAPT2"
