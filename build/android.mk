...
PACKAGE_PATH = $(subst .,/,$(ANDROID_PACKAGE))
...
$(MANIFEST_PROCESSED): $(MANIFEST_TEMPLATE) $(MANIFEST_PACKAGE_STAMP) | $(ANDROID_OUTPUT_DIR)/dirstamp
	...
	$(Q)sed -e 's/@PACKAGE_NAME@/$(MANIFEST_PACKAGE)/g' \
		...
		-e 's|@ANDROID_VERSIONCODE@|$(ANDROID_VERSIONCODE)|g' \
...
$(GEN_DIR)/$(PACKAGE_PATH)/R.java: $(ANDROID_OUTPUT_DIR)/resources.apk

# Note: Requires JDK 17 or later. JAVA_HOME should point to JDK 17 installation.
$(ANDROID_OUTPUT_DIR)/classes.jar: $(JAVA_SOURCES) $(GEN_DIR)/$(PACKAGE_PATH)/R.java | $(JAVA_CLASSFILES_DIR)/dirstamp
