...
TEST_PROFILE_DEPENDS = PROFILE MATH IO OS UTIL JSON
TEST_PROFILE_CPPFLAGS = -DTESTING_APP
...
RUN_DOWNLOAD_TO_FILE_DEPENDS = LIBHTTP JSON ASYNC LIBNET OPERATION IO OS THREAD UTIL
