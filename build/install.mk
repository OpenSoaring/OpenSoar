...
uninstall-mo:
	for i in $(LINGUAS); do \
		rm -f $(prefix)/share/locale/$$i/LC_MESSAGES/$(PROGRAM_NAME_LC).mo; \
	done

uninstall-bin:
	rm -f $(prefix)/bin/$(PROGRAM_NAME) $(prefix)/bin/vali-xcs

uninstall-manual:
	rm -f $(prefix)/share/doc/$(PROGRAM_NAME)/$(notdir $(MANUAL_PDF))
