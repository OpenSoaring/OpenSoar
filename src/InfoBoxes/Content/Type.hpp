...
namespace InfoBoxFactory
{
  enum Type {
    ...
    e_SpeedTaskEst, // Estimated (predicted) whole-task average ...
    e_Home_AltDiff, // Arrival altitude at the home waypoint (if defined)...
    e_Alternate_1_AltDiff, // Arrival altitude at the best alternate landing..
    e_Alternate_2_AltDiff, // Arrival altitude at the second-best alternate ..
    /* 130 */
// ===============================================================
