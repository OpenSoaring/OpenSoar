...
#if 1 // TODO(August2111): reactivating or delete?
# define infobox_panel nullptr
#endif
/**
...
static constexpr MetaData meta_data_2nd[] = {
    ...
    // e_InstantaneousWindSpeed
    {
     ...
     IBFHelper<InfoBoxContentWindBearing>::Create, // UpdateInfoBoxInstWindBearing,
        //nullptr, // UpdateInfoBoxInstWindSpeed,
        // wind_infobox_panels,
    },
    ...
    // e_Mouse,
    {
        ...
        N_("Mouse Pos"),
        N_("Mouse"),
        N_("Mouse Position (x/y)."),
        UpdateInfoBoxMousePositionXY,
    },
    // e_Coordinates,
    {
        "System", 
    ...
    // e_MouseDistance,
    {
        ...
        N_("Mouse Distance"),
        N_("Distance"),
        N_("Mouse Distance (km and )."),
        UpdateInfoBoxMouseDistance,
    },
};
