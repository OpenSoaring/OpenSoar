...
{
  snprintf(output_buffer, sizeof(output_buffer), edit_format, value);
...
{
  snprintf(output_buffer, sizeof(output_buffer), display_format, value);
  return output_buffer;
}
                                   ...
                                   int value) const noexcept
{
  ...
  snprintf(a, sizeof(a), edit_format, value);
  snprintf(b, sizeof(b),display_format, value);
