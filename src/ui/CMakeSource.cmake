...
if(ENABLE_OPENGL)
    list(APPEND SCREEN_SOURCES       
        ...
        # ${CANVAS_SRC_DIR}/opengl/Dynamic.cpp  # removed upstream (inline vars)
        ...
        # ${CANVAS_SRC_DIR}/opengl/Shapes.cpp  # removed upstream (shader-based)
...
if (ENABLE_SDL)
    ...
    # font file lookup: upstream screen.mk CANVAS_FILES_CPP -
    # windows/Files.cpp on Windows+FreeType (added below for WIN32),
    # custom/Files.cpp (fontconfig paths) elsewhere
    if (NOT WIN32)
        list(APPEND SCREEN_SOURCES ${CANVAS_SRC_DIR}/custom/Files.cpp)
    endif()

    # SDL without OpenGL -> software renderer (upstream: OPENGL=n)
    if (NOT ENABLE_OPENGL AND NOT OPENGL)
...
# Windows builds always use SDL/OpenGL (ENABLE_SDL above); the GDI
# backend was removed upstream, so there is no source list for it
# any more.
endif()
