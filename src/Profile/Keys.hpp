...
constexpr std::string_view VarioDisplayCirclingCenter = "VarioDisplayCirclingCenter";
constexpr std::string_view VarioDisplayCirclingInfo1 = "VarioDisplayCirclingInfo1";
constexpr std::string_view VarioDisplayCirclingInfo2 = "VarioDisplayCirclingInfo2";
constexpr std::string_view VarioDisplayCirclingInfo3 = "VarioDisplayCirclingInfo3";
constexpr std::string_view VarioDisplayStraightCenter = "VarioDisplayStraightCenter";
constexpr std::string_view VarioDisplayStraightInfo1 = "VarioDisplayStraightInfo1";
constexpr std::string_view VarioDisplayStraightInfo2 = "VarioDisplayStraightInfo2";
constexpr std::string_view VarioDisplayStraightInfo3 = "VarioDisplayStraightInfo3";
...
constexpr std::string_view LocalTimeSource = "LocalTimeSource";
