...
ParsePFLAM(NMEAInputLine &line) noexcept
{
  ...
  if (type == "U") {
    ...
    const bool is_hex_payload = msg_type == "AREG" || msg_type == "PNAME" ||
                                msg_type == "ATYPE" || msg_type == "ACALL";
