...
/* Profile/DeviceConfig.cpp consults the blackboard for the sensor
   calibration; this test never reaches that path, but the linker still
   wants the objects the main program provides. */
