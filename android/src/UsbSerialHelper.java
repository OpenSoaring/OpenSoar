...
public final class UsbSerialHelper extends BroadcastReceiver {
  ...
  private static final String ACTION_USB_PERMISSION = "de.opensoar.otg.action.USB_PERMISSION";
  ...
  private static final long[] supported_ids = createTable(
    ...
    createDevice(0x2341, 0x8036), // Arduino Leonardo
    createDevice(0x1209, 0x8500), // SteFly Remote Stick
    createDevice(0x1209, 0x8502), // SteFly Rotary Control
